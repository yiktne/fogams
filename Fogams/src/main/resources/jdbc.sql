...
SELECT COM.COMPANY_NO, COMPANY_IMG, COMPANY_PRODUCT, COMPANY_MONEY FROM COMPANY COM INNER JOIN COMPANY_PRICE PRICE ON COM.COMPANY_NO=PRICE.COMPANY_NO;
...
SELECT PLANLIST_SEQ.CURRVAL FROM DUAL;
...
CREATE TABLE PLAN(
	PLAN_NO NUMBER NOT NULL,
	COMPANY_NO NUMBER NOT NULL,
	PLAN_TIME VARCHAR2(50) NOT NULL,
